...
def sql_videos(database, col_input):
    ...
    #video_statistics['favourite_count'] = pd.to_numeric(video_statistics['favourite_count'])
...
def sql(database,col_input):
    ...
    try:
        #nan_rows = video_statistics[video_statistics.isna().any(axis=1)]
        #print(nan_rows)
...
def query10():
    ...
    # combine all queries in single function
...
def sql_query():
    ...
    q4 = 'Q4-Which videos have the highest number of comments with their corresponding channel names?'
    ...
    q10 = 'Q10-How many comments were made on each video with their corresponding video names?'
...
def main():
    ...
    if st.button("Get Details"):
        ...
        st.write('store data in mongodb atlas')
        ...
        sql_query()
        st.header("Data Visualisation Using Bar and Pie Chart Along Dataframes")

        st.write('Q1-What are the names of all the videos and their corresponding channels?')
        ...
        st.subheader('Highest video view count')
        data3 = query3()
        ...
        st.subheader('Total comments for each video of  all channel')
        data4 = query4()
        ...
        st.subheader('Highest likes on video')
        data5 = query5()
        ...
        st.subheader('Total likes on video')
        data6 = query6()
        ...
        st.subheader('Total views on channel')
        data7 = query7()
        ...
        st.subheader('Total Published videos on channel on  current year')
        data8 = query8(2023)
        ...
        st.subheader('Highest comment count of a video')
        data10 = query10()
